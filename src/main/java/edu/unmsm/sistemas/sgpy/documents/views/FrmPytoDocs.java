 ...
 */
package edu.unmsm.sistemas.sgpy.documents.views;

import edu.unmsm.sistemas.sgpy.documents.controller.PytoDocsController;
import edu.unmsm.sistemas.sgpy.documents.entities.Entregables;
...
import edu.unmsm.sistemas.sgpy.documents.entities.TipoEntreg;
import edu.unmsm.sistemas.sgpy.documents.repository.PytoDocsDAO;
import edu.unmsm.sistemas.sgpy.documents.repository.drive.DriveConnection;
import edu.unmsm.sistemas.sgpy.documents.repository.drive.DriveConstants;
import edu.unmsm.sistemas.sgpy.documents.repository.imple.EntregablesDAOImple;
import edu.unmsm.sistemas.sgpy.documents.repository.imple.EstadoDAOImple;
import edu.unmsm.sistemas.sgpy.documents.repository.imple.FaseDAOImple;
import edu.unmsm.sistemas.sgpy.documents.repository.imple.NivelDAOImple;
import edu.unmsm.sistemas.sgpy.documents.repository.imple.PytoDocsDAOImple;
import edu.unmsm.sistemas.sgpy.documents.repository.imple.TipoDocDAOImple;
import edu.unmsm.sistemas.sgpy.documents.repository.imple.TipoEntregDAOImple;
import edu.unmsm.sistemas.sgpy.documents.views.util.TableModelCreator;
