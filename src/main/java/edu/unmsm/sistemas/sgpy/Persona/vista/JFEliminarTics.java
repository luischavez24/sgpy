 ...
 * @author CARLOS
 */
public class JFEliminarTics extends javax.swing.JFrame {

    /**
     * Creates new form JFVisualizarTics
     */
    public JFEliminarTics() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 91, 159, 330));
        ...
        getContentPane().add(labelBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 94, -1, -1));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 294, -1, -1));
        getContentPane().add(labelIconoTics, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 100, 200, 200));

        jLabel5.setFont(new java.awt.Font("Dialog", 2, 24)); // NOI18N
        jLabel5.setText("Eliminar Tics");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 20, -1, -1));
        getContentPane().add(textCodigoTics, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 90, 210, 28));
        getContentPane().add(textDescripcionTics, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 230, 210, 28));
        getContentPane().add(textVigenciaTics, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 290, 210, 28));
        ...
        btnEliminarTics.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        btnEliminarTics.setText("<html><p>Eliminar</p><p>registro</p></html>");
        getContentPane().add(btnEliminarTics, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 350, -1, -1));
        ...
        getContentPane().add(radioPorCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(454, 130, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 452, -1, -1));
    ...
    private void listaTicsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listaTicsMouseClicked
        if(evt.getClickCount() == 1){
            textDescripcionTics.setEditable(true);
            ...
            textDescripcionTics.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFEliminarTics.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFEliminarTics().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JButton btnEliminarTics;
