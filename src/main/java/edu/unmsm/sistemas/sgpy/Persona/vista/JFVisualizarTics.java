 ...
 * @author CARLOS
 */
public class JFVisualizarTics extends javax.swing.JFrame {

    /**
     * Creates new form JFVisualizarTics
     */
    public JFVisualizarTics() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 111, 159, 310));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 189, -1, -1));

        jLabel3.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel3.setText("Vigencia :");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 251, -1, -1));
        getContentPane().add(labelIconoTics, new org.netbeans.lib.awtextra.AbsoluteConstraints(584, 110, 180, 180));

        jLabel5.setFont(new java.awt.Font("Dialog", 2, 24)); // NOI18N
        jLabel5.setText("Visualizar Tics");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 20, -1, -1));
        getContentPane().add(textCodigoTics, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 115, 200, 28));
        getContentPane().add(textDescripcionTics, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 185, 200, 28));
        getContentPane().add(textVigenciaTics, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 248, 200, 28));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(685, 452, -1, -1));
    ...
    private void listaTicsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listaTicsMouseClicked
        if(evt.getClickCount() == 1){
            textCodigoTics.setEditable(true);
            ...
            textCodigoTics.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFVisualizarTics.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFVisualizarTics().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel labelIconoTics;
    public javax.swing.JList<String> listaTics;
    private javax.swing.JTextField textCodigoTics;
    private javax.swing.JTextField textDescripcionTics;
    private javax.swing.JTextField textVigenciaTics;
